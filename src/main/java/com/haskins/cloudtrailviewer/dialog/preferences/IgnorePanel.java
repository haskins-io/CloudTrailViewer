...
import com.haskins.cloudtrailviewer.dialog.preferences.dialogs.IgnoreDialog;
...
class IgnorePanel extends JPanel implements Preferences, ActionListener {
    ...
    IgnorePanel() {
        ...
        for (ResultSetRow row : rows) {
            ...
            String aws_name = (String)row.get("ignore");
    ...
    private void buildUI() {
        ...
        JLabel title = new JLabel("Ignore Strings");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equalsIgnoreCase("New")) {
            ...
            if (selected != -1) {
                ...
                String query = "DELETE FROM ctv_ignores WHERE ignore = '" +  name+ "'";
