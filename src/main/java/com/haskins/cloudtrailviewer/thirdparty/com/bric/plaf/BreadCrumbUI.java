 ...
 */
package com.haskins.cloudtrailviewer.thirdparty.com.bric.plaf;
...
import com.haskins.cloudtrailviewer.thirdparty.com.bric.swing.NavigationListener.ListSelectionType;
import com.haskins.cloudtrailviewer.thirdparty.com.bric.swing.PaddedIcon;
import com.haskins.cloudtrailviewer.thirdparty.com.bric.swing.resources.TriangleIcon;
...
public class BreadCrumbUI extends ComponentUI {
     ...
     * Create a new BreadCrumbUI.
     *
     * @param artificiallySlow this is an option for debugging and
     * demonstration.
     */
    ...
    private class CrumbLayout implements LayoutManager {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (expectedWidth > availableWidth) {
                ...
                identifyFirstAbnormality:
                for (int j = crumbs.length - 2; j >= 0; j--) {
    ...
    class LabelMouseListener<T> extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            JBreadCrumb<T> jbc = (JBreadCrumb<T>) label.getParent();
    ...
    protected <E> void refreshUI(final JBreadCrumb<E> comp) {
        ...
        while (path != null && ctr < path.length) {
            ...
            newLabel.addMouseListener(new LabelMouseListener<E>());
            comp.add(newLabel);
