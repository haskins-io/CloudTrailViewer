 ...
 * <p>
 * <img src="https://javagraphics.java.net/resources/screenshot_breadcrumb_demo.png" alt="Sample Screenshots of JBreadCrumb">
 *
...
public class JBreadCrumb<T> extends JComponent {
     ...
     * opportunity to format that label. For example, if this component
     * navigated <code>java.io.Files</code>, then you should apply a
    ...
    public static interface BreadCrumbFormatter<T> {
         ...
         * <p>
         * For example: this might add specific icons, or change the font or
         * opacity based on what this label is representing.
         *
    ...
    /**
     * Add a <code>PropertyChangeListener</code> for this key to be notified
     ...
     *
     * @param path the path to display. This should not be null, or contain any
     * null elements.
     */
    ...
    public void updateUI() {
        if (UIManager.getDefaults().get(uiClassID) == null) {
            UIManager.getDefaults().put(uiClassID, "com.haskins.cloudtrailviewer.thirdparty.com.bric.plaf.BreadCrumbUI");
        }
