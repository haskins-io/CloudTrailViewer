...
public class EbResource extends AbstractResource implements Resource {
    ...
    ///// private methods
    ////////////////////////////////////////////////////////////////////////////
    private void populateApplicationName(Event event, ResourceInfo resources) {
    ...
    private void populateEnvironmentName(Event event, ResourceInfo resources) {
    ...
    private void populateEnvironmentId(Event event, ResourceInfo resources) {
        getTopLevelResource(ENVIRONMENT_ID, "environmentId", event, resources);
        
        getTopLevelParameters(event, resources, "environmentId");
    }
    
    private void describeEnvironments(Event event, ResourceInfo resources) {
    ...
    private void checkDnsAvailable(Event event, ResourceInfo resources) {
        getTopLevelResource("cName", "cNAMEPrefix", event, resources);
    }
    
    private void createApplicationVersion(Event event, ResourceInfo resources) {
        getTopLevelResource(APPLICATION_NAME, "applicationName", event, resources);
    ...
    private void createStorageLocation(Event event, ResourceInfo resources) {
        getTopLevelResource("S3 Bucket", "s3Bucket", event, resources);
    }

    private void deleteApplicationVersion(Event event, ResourceInfo resources) {
        getTopLevelResource(APPLICATION_NAME, "applicationName", event, resources);
        getTopLevelResource("Version Label", "versionLabel", event, resources);
