...
public class SnsResource extends AbstractResource implements Resource {
    ...
    ///// private methods
    ////////////////////////////////////////////////////////////////////////////
    private void createTopic(Event event, ResourceInfo resources) {
        getTopLevelResource(TOPIC, "name", event, resources);
        
        getTopLevelParameters(event, resources, "name");
    }

    private void deleteEndpoint(Event event, ResourceInfo resources) {
        getTopLevelResource("Endpoint", "endpointArn", event, resources);
        
        getTopLevelParameters(event, resources, "endpointArn");
    }
    
    private void deleteTopic(Event event, ResourceInfo resources) {
        getTopLevelResource(TOPIC, "topicArn", event, resources);
        
        getTopLevelParameters(event, resources, "topicArn");
    }
    
    private void getSubscriptionAttributes(Event event, ResourceInfo resources) {
        getTopLevelResource("Subscription", "subscriptionArn", event, resources);
        
        getTopLevelParameters(event, resources, "subscriptionArn");
    }
    
    private void getTopicAttributes(Event event, ResourceInfo resources) {
        getTopLevelResource(TOPIC, "topicArn", event, resources);
        
        getTopLevelParameters(event, resources, "topicArn");
    }
    
    private void listSubscriptionsByTopic(Event event, ResourceInfo resources) {
        getTopLevelResource(TOPIC, "topicArn", event, resources);
        
        getTopLevelParameters(event, resources, "topicArn");
    }
    
    private void setSubscriptionAttributes(Event event, ResourceInfo resources) {
        getTopLevelResource("Subscription", "subscriptionArn", event, resources);
        getTopLevelParameters(event, resources, "subscriptionArn");
    }
    
    private void setTopicAttributes(Event event, ResourceInfo resources) {
        getTopLevelResource(TOPIC, "topicArn", event, resources);
        getTopLevelParameters(event, resources, "topicArn");
    }
    
    private void subscribe(Event event, ResourceInfo resources) {
        getTopLevelResource(TOPIC, "topicArn", event, resources);
        getTopLevelParameters(event, resources, "topicArn");
    }
    
    private void unsubscribe(Event event, ResourceInfo resources) {
        getTopLevelResource("Subscription", "subscriptionArn", event, resources);
