...
public class AsResource extends AbstractResource implements Resource {
    ...
    private static final String AUTO_SCALING_GROUP = "AutoScaling Group";
    ...
    ///// private methods
    ////////////////////////////////////////////////////////////////////////////
    private void getAutoScalingGroupDetails(Event event, ResourceInfo resources) {
    ...
    private void createLaunchConfiguration(Event event, ResourceInfo resources) {
    ...
    private void deletePolicy(Event event, ResourceInfo resources) {
        getTopLevelResource("Policy", "policyName", event, resources);
        
        getTopLevelParameters(event, resources, "policyName");
    }
    
    private void putScalingPolicy(Event event, ResourceInfo resources) {
    ...
    private void terminateInstanceInAutoScalingGroup(Event event, ResourceInfo resources) {
