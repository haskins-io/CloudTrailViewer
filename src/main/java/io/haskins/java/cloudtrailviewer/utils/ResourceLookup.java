...
import io.haskins.java.cloudtrailviewer.model.aws.resource.*;
...
public class ResourceLookup {
    ...
    private static Map<String, Resource> getServices() {
        
        return Collections.unmodifiableMap(new HashMap<String, Resource>() {
            {
    ...
    public static void getResourceInfo(Event event, ResourceInfo resources) {
        ...
        if (getServices().containsKey(source)) {
            ...
            try {
                Resource r = getServices().get(source);
