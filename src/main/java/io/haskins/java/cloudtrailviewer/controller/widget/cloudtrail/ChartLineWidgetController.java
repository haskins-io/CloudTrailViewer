 ...
 */
public class ChartLineWidgetController extends XYChartController {
    ...
    public BorderPane loadFXML() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/widget/cloudtrail/ChartLineWidget.fxml"));
    ...
    protected FontAwesomeIconView getWidgetIcon() {
        return new FontAwesomeIconView(FontAwesomeIcon.LINE_CHART);
    }
