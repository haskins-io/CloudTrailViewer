package io.haskins.java.cloudtrailviewer.controller.widget.elblogs;
...
/**
 * Controller for a ELB Log Table.
 *
 * Created by markhaskins on 10/10/2017.
 */
public class ElbLogTableWidgetController extends AbstractBaseController {
    ...
    public BorderPane loadFXML() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/widget/elblogs/TableWidget.fxml"));
